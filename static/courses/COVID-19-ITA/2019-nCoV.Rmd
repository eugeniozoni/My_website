...
groups<-c(replicate(101, "hospital"), replicate(26, "icu"), replicate(94, "home"),
          ...
          replicate(24134, "hospital"), replicate(2471, "icu"), replicate(81104, "home"),
          replicate(23805, "hospital"), replicate(2384, "icu"), replicate(81510, "home"),
          replicate(22871, "hospital"), replicate(2267, "icu"), replicate(81710, "home"),
          replicate(22068, "hospital"), replicate(2173, "icu"), replicate(82286, "home"),
          replicate(21533, "hospital"), replicate(2102, "icu"), replicate(82212, "home"),
          replicate(21372, "hospital"), replicate(2009, "icu"), replicate(82722, "home"),
          replicate(20353, "hospital"), replicate(1956, "icu"), replicate(83504, "home"),
          replicate(19723, "hospital"), replicate(1863, "icu"), replicate(83619, "home"),
          replicate(19210, "hospital"), replicate(1795, "icu"), replicate(83652, "home"),
          replicate(18149, "hospital"), replicate(1694, "icu"), replicate(81708, "home"),
          replicate(17569, "hospital"), replicate(1578, "icu"), replicate(81796, "home"),
          replicate(17357, "hospital"), replicate(1539, "icu"), replicate(81808, "home"),
          replicate(17242, "hospital"), replicate(1501, "icu"), replicate(81436, "home"),
          replicate(16823, "hospital"), replicate(1479, "icu"), replicate(81678, "home"),
          replicate(16270, "hospital"), replicate(1427, "icu"), replicate(80770, "home"),
          replicate(15769, "hospital"), replicate(1333, "icu"), replicate(74426, "home"),
          replicate(15174, "hospital"), replicate(1311, "icu"), replicate(73139, "home"),
          replicate(14636, "hospital"), replicate(1168, "icu"), replicate(72157, "home"),
          replicate(13834, "hospital"), replicate(1034, "icu"), replicate(69974, "home"),
          replicate(13618, "hospital"), replicate(1027, "icu"), replicate(68679, "home"),
          replicate(13539, "hospital"), replicate(999, "icu"), replicate(67950, "home")
                  )
...
set.seed(1)
pred_ITA_new_after_shut <- project(i_ITA[16:78], R = median(growth_R0_after), si = si_ITA_n, n_days = 10, n_sim = 1000)
...
set.seed(1)
pred_ITA_new_after_peak <- project(i_ITA[27:78], R = median(growth_R0_after_peak), si = si_ITA_n, n_days = 10, n_sim = 1000)
