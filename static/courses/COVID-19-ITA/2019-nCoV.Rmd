...
set.seed(1)
pred_ITA_new_after_shut <- project(i_ITA[16:55], R = median(growth_R0_after), si = si_ITA_n, n_days = 10, n_sim = 1000)
...
set.seed(1)
pred_ITA_new_after_peak <- project(i_ITA[27:55], R = median(growth_R0_after_peak), si = si_ITA_n, n_days = 10, n_sim = 1000)
